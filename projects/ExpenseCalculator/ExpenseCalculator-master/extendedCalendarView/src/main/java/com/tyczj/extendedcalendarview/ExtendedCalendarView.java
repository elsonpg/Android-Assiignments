...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener,
	...
	private OnNextMonthClickListener nextMonthListener;
	...
	public interface OnNextMonthClickListener{
		public void onNextMonthClicked(String month);
	}
	...
	public void setOnNextMonthClickListener(OnNextMonthClickListener listener)
	{
		nextMonthListener = listener;
		nextMonthListener.onNextMonthClicked(month.getText().toString());
	}
