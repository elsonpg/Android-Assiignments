...
public class CalendarProvider extends ContentProvider {
	...
	public static final String YESCOUNT = "yes_count";
	public static final String NOCOUNT = "no_count";
	public static final String MAYBECOUNT = "maybe_count";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper{
    	...
    	private void createTables(SQLiteDatabase db){
    		db.execSQL("CREATE TABLE " + EVENTS_TABLE + "(" + ID + " integer primary key autoincrement, " +
    				...
    				+ START + " INTEGER, "+ END + " INTEGER, " + START_DAY + " INTEGER, " + END_DAY + " INTEGER, " + COLOR +" INTEGER, "+ YESCOUNT +" TEXT, "
    				+ NOCOUNT + " TEXT, "+ MAYBECOUNT + " TEXT, "+ MYSTATUS + " TEXT,"+ POSTAUTHOR + " TEXT);");
    	}
    }
	...
	static{
		...
		mMap.put(YESCOUNT, YESCOUNT);	
		mMap.put(NOCOUNT, NOCOUNT);
		mMap.put(MAYBECOUNT, MAYBECOUNT);
		mMap.put(MYSTATUS, MYSTATUS);
		mMap.put(POSTAUTHOR, POSTAUTHOR);
